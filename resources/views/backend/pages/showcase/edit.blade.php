          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Vitrin Ekle / Düzenle <small></small></h3>
              </div>
            ...
            <div class="row">
             ...
             <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                       <form action="{{ route('showcases.update',$showcase->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask">
                              {{ csrf_field() }}
                        {{ method_field('PUT') }}
                     
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="name" value="{{ $showcase->name }}"  placeholder="Başlık">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="priority" value="{{ $showcase->priority }}" style="width: 25%" required placeholder="Sıra">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="link" value="{{ $showcase->link }}" required placeholder="Link">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                          ...
                          <img src="{{ url('uploads/showcases/'.$showcase->image) }}" style="width: 30%">
                      </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                      @if($showcase->count()>0)
                        @foreach($showcases as $showcases)
                        <tr>
                          <td>{{ $showcases->name }}</td>
                          <td>{{ $showcases->link }}</td>
                          <td>{{ $showcases->priority }}</td>
                          <td> <form action="{{ route('showcases.destroy',$showcases->id) }}" method="post"> <a href="{{ route('showcases.edit',$showcases->id) }}" class="btn btn-success">Düzenle</a>{{ csrf_field() }} {{ method_field('DELETE') }}<button type="submit"  class="btn btn-danger">Sil</button></form></td>
