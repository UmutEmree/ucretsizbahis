            ...
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask">
                        {{ csrf_field() }}
                        <input type="hidden" name="priority" value="@if($plast){{ $plast->priority+1 }}@else{{ '1' }}@endif">
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="slug" value="{{ old('slug') }}" required placeholder="Slug">
                        <span class="fa fa-code form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="marka" value="{{ old('marka') }}" required placeholder="Marka Adı">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                          <select name="type" class="form-control">
                            <option value="bonus">Bonus İnceleme</option>
                      ...
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" name="link" value="{{ old('link') }}" placeholder="Affiliate Linki">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                           <input type="hidden" name="week" value="0">
                              <input type="checkbox" name="week" class="js-switch" value="1" />Haftanın Bonusu
                            </label>
                          </div>
                         </div>
                        ...
                        <input type="hidden" name="freebonus" value="0">
                              <input type="checkbox" name="freebonus" class="js-switch" value="1" />Free Bonusu
                            </label>
                         </div>
                      </div>
              ...
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" value="{{ old('guven') }}" style="width: 30%" name="guven" required placeholder="Güvenilirlik">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" value="{{ old('paracekme') }}" style="width: 30%" name="paracekme" required placeholder="Para Çekme">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" value="{{ old('bonuslar') }}" style="width: 30%" name="bonuslar" required placeholder="Bonuslar">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" value="{{ old('oranlar') }}" style="width: 30%" name="oranlar" required placeholder="Oranlar">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" value="{{ old('destek') }}" style="width: 30%" name="destek" required placeholder="Destek">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>

                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2" value="{{ old('title') }}" name="title" required placeholder="Meta Title">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>
                      <div class="control-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                          <input id="tags_1" type="text" name="bonus" class="tags form-control" value="{{ old('bonus') }}" />
                          <div id="suggestions-container" style="position: relative; float: left; width: 250px; margin: 10px;"></div>
                        </div>
                      </div>
               
                      <div class="col-md-12 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="inputSuccess2"  name="meta" value="{{ old('meta') }}" placeholder="Meta Description">
                        <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                      </div>
