    ...
    <div class="innner_banner">
        <div class="container">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><span>Tüm İncelemeler</span></li>
            </ul>
        </div>
    </div>
    <!--Inner Banner End-->
                        ...
                        <div class="kf_featured_wrap3">
                           ...
                           @foreach($posts as $inceleme)
                            <div class="kf_featured_thumb">
                                <figure>
                                    <a href="{{ url('inceleme/'.$inceleme->slug) }}"><img src="{{ url('uploads/posts/'.$inceleme->image )}}" class="img-responsive" height="350px" alt="{{ $inceleme->title }}"></a>
                                </figure>
